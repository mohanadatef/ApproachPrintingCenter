...
<div class="wrapper">
    ...
    <div class="content-wrapper">
        ...
        <div class="col-md-12">
            <div class="card">
                ...
                <div class="card-body">
                    <form autocomplete="off" id='password' action="{{url('admin/user/reset/'.$user->id)}}" method="POST">
                        {{csrf_field()}}
    ...
    @include('includes.admin.scripts')
        ...
        {!! JsValidator::formRequest('App\Http\Requests\User\UserResetPasswordCreateRequest','#password') !!}
