...
<div class="wrapper">
    ...
    <div class="content-wrapper">
        ...
        <div class="col-md-12">
            ...
            <form autocomplete="off" id="create" action="{{url('admin/color/create')}}" method="POST">
                {{csrf_field()}}
    ...
    @include('includes.admin.scripts')
        {!! JsValidator::formRequest('App\Http\Requests\admin\Color\ColorCreateRequest','#create') !!}
</div>
</body>
</html>