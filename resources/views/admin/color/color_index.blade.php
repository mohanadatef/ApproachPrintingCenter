                        ...
                        <div align="center" class="col-md-12 table-responsive">
                            <table id="dynamic-table" class="table table-striped table-bordered table-hover">
                                ...
                                @foreach($color as $colors)
                                    <tr>
                                        <td class="center">{{ $colors->order }}</td>
                                        <td class="center">{{ $colors->name }}</td>
                                        <td class="center">
                                            @permission('color-edit')
                                            <a href="{{ url('/admin/color/edit/'.$colors->id)}}"><i class="ace-icon fa fa-edit bigger-120  edit" data-id="">edit</i></a>
                                            @endpermission
                                        </td>
                                    </tr>
                                @endforeach
