                        ...
                        <div align="center" class="col-md-12 table-responsive">
                            <table id="dynamic-table" class="table table-striped table-bordered table-hover">
                                ...
                                <tr>
                                    ...
                                    @if(count($machine)>0)
                                    @permission('laser-start')
                                    <th class="center">Control</th>
                                    @endpermission
                                    @permission('laser-skip')
                                ...
                                @foreach($order_laser as $orderlaser)
                                    <tr>
                                        ...
                                        @permission('laser-start')
                                        <td class="center">
                                            <a href="{{ url('/admin/order/laser/information/'.$orderlaser->id)}}"><i class="ace-icon fa fa-edit bigger-120  edit" data-id="">start</i></a>
                                        </td>
                                        @endpermission
                                        @permission('laser-skip')
                                        <td class="center">
                                            <a href="{{ url('/admin/order/laser/code/'.$orderlaser->id)}}"><i class="ace-icon fa fa-edit bigger-120  edit" data-id="">skip</i></a>
                                        </td>
                                        @endpermission
                                            @endif
                                    </tr>
