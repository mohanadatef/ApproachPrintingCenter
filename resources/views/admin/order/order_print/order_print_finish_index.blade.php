                            ...
                            <table id="dynamic-table" class="table table-striped table-bordered table-hover">
                                ...
                                @foreach($order_print as $orderprint)
                                    <tr>
                                        ...
                                        <td class="center">
                                            <a href="{{ url('/admin/order/print/information/reply/'.$orderprint->id)}}"><i class="ace-icon fa fa-edit bigger-120  edit" data-id="">information</i></a>
                                        </td>
                                        @endpermission
                                        @permission('chasier-print-discarded')
                                        @if($orderprint->status==3)
                                            <td class="center">
